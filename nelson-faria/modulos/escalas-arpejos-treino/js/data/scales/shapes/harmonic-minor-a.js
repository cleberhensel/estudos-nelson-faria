(function (global) {
  ...
  global.EatData.harmonicMinorAShape = {
    id: 'harmonic-minor.A',
    familyId: 'harmonic-minor',
    cagedId: 'A',
    order: 1,
    name: 'A shape · menor harmônica',
    anchorRef: 'A',
    ui: { hex: '#4ecdc4' },
    notes: [
      [n(2, '5'), n(3, '♭6'), n(6, '7', false, true)],
      [n(2, '2'), n(3, '♭3'), n(5, '4')],
      [n(3, '7', false, true), n(4, '1', true)],
      [n(2, '4'), n(4, '5'), n(5, '♭6', false, true)],
